...
export default function Counter() {
  ...
  return (
    <div className="p-4">
      ...
      <button onClick={incrementCounter} className="bg-blue-500 text-white px-4 py-2 rounded">
        Increment
      </button>
      <button onClick={resetCounter} className="bg-red-500 text-white px-4 py-2 rounded ml-2">
        Reset
      </button>
