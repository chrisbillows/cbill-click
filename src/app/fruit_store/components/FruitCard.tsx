...
export default function FruitCard({
  ...
  return (
    ...
    >
      ...
      <button
        className="mt-3 inline-flex items-center justify-center rounded bg-green-600 px-3 py-1 text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500"
